## polygon_ros (rolling) - 1.3.0-1

The packages in the `polygon_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release polygon_ros -r rolling` on `Fri, 22 Aug 2025 15:36:33 -0000`
...
## polygon_ros (jazzy) - 1.2.0-1

The packages in the `polygon_ros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy -y polygon_ros` on `Thu, 17 Apr 2025 17:00:35 -0000`
...
## polygon_ros (humble) - 1.2.0-1

The packages in the `polygon_ros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble polygon_ros` on `Thu, 17 Apr 2025 16:48:19 -0000`
...
## polygon_ros (rolling) - 1.2.0-1

The packages in the `polygon_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling polygon_ros` on `Tue, 15 Apr 2025 17:12:27 -0000`
...
## polygon_ros (rolling) - 1.1.0-1

The packages in the `polygon_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling polygon_ros -y` on `Wed, 11 Sep 2024 17:41:46 -0000`
...
## polygon_ros (jazzy) - 1.1.0-1

The packages in the `polygon_ros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy polygon_ros -y` on `Wed, 11 Sep 2024 17:40:05 -0000`
...
## polygon_ros (iron) - 1.1.0-1

The packages in the `polygon_ros` repository were released into the `iron` distro by running `/usr/bin/bloom-release -r iron polygon_ros -y` on `Wed, 11 Sep 2024 17:34:44 -0000`
