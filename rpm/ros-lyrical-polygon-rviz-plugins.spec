...
%global pkg_name polygon_rviz_plugins
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-polygon-rviz-plugins
Version:        1.3.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 David V. Lu!! <david@metrorobots.com> - 1.3.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 David V. Lu!! <david@metrorobots.com> - 1.3.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 David V. Lu!! <david@metrorobots.com> - 1.3.0-1
- Autogenerated by Bloom
